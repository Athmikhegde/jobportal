...
public class PostAdapter extends FirebaseRecyclerAdapter<Data, PostAdapter.MyViewHolder> {
    ...
    public PostAdapter(@NonNull FirebaseRecyclerOptions<Data> options) {
        super(options);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            mtitle = itemView.findViewById(R.id.titletxt);
            mdate = itemView.findViewById(R.id.datetxt);
            mdesc = itemView.findViewById(R.id.desctxt);
            mskill = itemView.findViewById(R.id.skillstxt);
            msalary = itemView.findViewById(R.id.salarystxt);
            mlink = itemView.findViewById(R.id.linkstxt);
